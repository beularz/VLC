...
//   return (
//     <div className="bg-gray-100 border-t px-4 py-2 flex flex-col">
//       <input
//         type="range"
//         value={progress}
//         onChange={handleSeek}
...
//           <button onClick={togglePlay} className="px-2 py-1 border rounded bg-white">
//             {playing ? "Pause" : "Play"}
//           </button>
//           <button onClick={stopVideo} className="px-2 py-1 border rounded bg-white">
//             Stop
//           </button>
//         </div>
